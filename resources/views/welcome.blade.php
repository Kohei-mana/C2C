                        ...
                        @auth
                            @php
                                if($product->user_id == Auth::user()->id){
                                    $route_name = 'exhibition-product';
                                }
                            @endphp
                        @endauth
                                        
                        <a href="{{ route($route_name, ['id'=>$product->id]) }}" class="scale-100 p-4 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
